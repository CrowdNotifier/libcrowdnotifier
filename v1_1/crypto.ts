...
/**
 * The cryptographic part of the QRcodes that need to be printed by the Location.
 */
...
export class CryptoV1_1 {
     ...
     */
    static scan(ent: Uint8Array, pEnt: Uint8Array, info: Uint8Array, aux: Uint8Array): IVisit {
        const pk = ent;
        const r1 = pEnt;
 ...
 */
function hashInfo(info: Uint8Array, r1: Uint8Array, r2: Uint8Array): Uint8Array{
